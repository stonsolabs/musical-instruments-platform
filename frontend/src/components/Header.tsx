        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <nav className="hidden xl:flex items-center justify-center flex-1">
            <div className="flex items-center space-x-3 lg:space-x-4 xl:space-x-5 flex-nowrap">
              ...
              <Link href="/products?category=drums-percussion" className="text-gray-900 hover:text-blue-600 transition-colors text-xs lg:text-sm font-medium whitespace-nowrap px-3 py-1 rounded">Drums & Percussion</Link>
              <Link href="/products?category=pianos-keyboards" className="text-gray-900 hover:text-blue-600 transition-colors text-xs lg:text-sm font-medium whitespace-nowrap px-3 py-1 rounded">Pianos & Keyboards</Link>
              <Link href="/products?category=orchestral" className="text-gray-900 hover:text-blue-600 transition-colors text-xs lg:text-sm font-medium whitespace-nowrap px-3 py-1 rounded">Orchestral</Link>
              <Link href="/products?category=live-sound-lighting" className="text-gray-900 hover:text-blue-600 transition-colors text-xs lg:text-sm font-medium whitespace-nowrap px-3 py-1 rounded">Live Sound & Lighting</Link>
              <Link href="/products?category=studio-production" className="text-gray-900 hover:text-blue-600 transition-colors text-xs lg:text-sm font-medium whitespace-nowrap px-3 py-1 rounded">Studio & Production</Link>
              <Link href="/products?category=music-software" className="text-gray-900 hover:text-blue-600 transition-colors text-xs lg:text-sm font-medium whitespace-nowrap px-3 py-1 rounded">Music Software</Link>
              <Link href="/products?category=dj-equipment" className="text-gray-900 hover:text-blue-600 transition-colors text-xs lg:text-sm font-medium whitespace-nowrap px-3 py-1 rounded">DJ Equipment</Link>
              <Link href="/products?category=home-audio" className="text-gray-900 hover:text-blue-600 transition-colors text-xs lg:text-sm font-medium whitespace-nowrap px-3 py-1 rounded">Home Audio</Link>
            </div>
          </nav>
