...
interface ControlledSearchAutocompleteProps {
  placeholder?: string;
  className?: string;
  value: string;
...
export default function ControlledSearchAutocomplete({
    ...
    <div className={`relative ${className}`}>
      <div className="relative">
        <input
          ...
          className="w-full px-4 py-3 pl-12 pr-12 text-gray-900 bg-white/90 border-0 rounded-lg focus:ring-2 focus:ring-blue-400 focus:bg-white transition-all placeholder-gray-500"
        />
