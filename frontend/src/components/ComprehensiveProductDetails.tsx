  ...
  return (
    <div className="space-y-8">
      ...
      <section className="bg-white rounded-xl shadow-elegant border border-primary-200 overflow-hidden">
        <div className="p-8">
          <SectionHeader sectionKey="technicalAnalysis" title="Technical Analysis" />
          
          {openSections.technicalAnalysis && (
            <>
              ...
              <div className="mb-6">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-primary-700">{aiContent?.technical_analysis?.sound_characteristics?.tonal_profile || 'Not available'}</p>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-primary-500">Output Level</span>
                    <p className="text-primary-700">{aiContent?.technical_analysis?.sound_characteristics?.output_level || 'Not available'}</p>
                  </div>
                  <div>
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-primary-700">{aiContent?.technical_analysis?.build_quality?.construction_type || 'Not available'}</p>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-primary-500">Hardware Quality</span>
                    <p className="text-primary-700">{aiContent?.technical_analysis?.build_quality?.hardware_quality || 'Not available'}</p>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-primary-500">Finish Quality</span>
                    <p className="text-primary-700">{aiContent?.technical_analysis?.build_quality?.finish_quality || 'Not available'}</p>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-primary-500">Expected Durability</span>
                    <p className="text-primary-700">{aiContent?.technical_analysis?.build_quality?.expected_durability || 'Not available'}</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-primary-700">{aiContent?.technical_analysis?.playability?.neck_profile || 'Not available'}</p>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-primary-500">Action Setup</span>
                    <p className="text-primary-700">{aiContent?.technical_analysis?.playability?.action_setup || 'Not available'}</p>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-primary-500">Comfort Rating</span>
                    <p className="text-primary-700">{aiContent?.technical_analysis?.playability?.comfort_rating || 'Not available'}</p>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-primary-500">Weight Category</span>
                    <p className="text-primary-700">{aiContent?.technical_analysis?.playability?.weight_category || 'Not available'}</p>
                  </div>
                </div>
              </div>
            </>
      ...
      <section className="bg-white rounded-xl shadow-elegant border border-primary-200 overflow-hidden">
        <div className="p-8">
          <SectionHeader sectionKey="purchaseDecision" title="Purchase Decision Guide" />
          
          {openSections.purchaseDecision && (
            <>
              {/* Why Buy */}
              <div className="mb-6">
      ...
      <section className="bg-white rounded-xl shadow-elegant border border-primary-200 overflow-hidden">
        <div className="p-8">
          <SectionHeader sectionKey="usageGuidance" title="Usage Guidance" />
          
          {openSections.usageGuidance && (
            <>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-primary-700">{aiContent?.usage_guidance?.skill_development?.learning_curve || 'Not available'}</p>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-primary-500">Growth Potential</span>
                    <p className="text-primary-700">{aiContent?.usage_guidance?.skill_development?.growth_potential || 'Not available'}</p>
                  </div>
                </div>
              </div>
            </>
      ...
      <section className="bg-white rounded-xl shadow-elegant border border-primary-200 overflow-hidden">
        <div className="p-8">
          <SectionHeader sectionKey="maintenanceCare" title="Maintenance & Care" />
          
          {openSections.maintenanceCare && (
            <>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="text-primary-700 text-sm">{aiContent?.maintenance_care?.care_instructions?.daily || 'Not available'}</p>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-primary-500">Weekly</span>
                      <p className="text-primary-700 text-sm">{aiContent?.maintenance_care?.care_instructions?.weekly || 'Not available'}</p>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-primary-500">Monthly</span>
                      <p className="text-primary-700 text-sm">{aiContent?.maintenance_care?.care_instructions?.monthly || 'Not available'}</p>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-primary-500">Annual</span>
                      <p className="text-primary-700 text-sm">{aiContent?.maintenance_care?.care_instructions?.annual || 'Not available'}</p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <p className="text-primary-700">{aiContent?.maintenance_care?.upgrade_potential?.recommended_budget || 'Not available'}</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="bg-white rounded-xl shadow-elegant border border-primary-200 overflow-hidden">
        <div className="p-8">
          <SectionHeader sectionKey="professionalAssessment" title="Professional Assessment" />
          
          {openSections.professionalAssessment && (
            <>
              {/* Expert Ratings */}
              <div className="mb-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center p-4 bg-primary-50 rounded-lg">
                    <div className="text-2xl font-bold text-success-600">{aiContent?.professional_assessment?.expert_rating?.build_quality || 0}/10</div>
                    <div className="text-sm text-primary-600">Build Quality</div>
                  </div>
                  <div className="text-center p-4 bg-primary-50 rounded-lg">
                    <div className="text-2xl font-bold text-accent-600">{aiContent?.professional_assessment?.expert_rating?.sound_quality || 0}/10</div>
                    <div className="text-sm text-primary-600">Sound Quality</div>
                  </div>
                  <div className="text-center p-4 bg-primary-50 rounded-lg">
                    <div className="text-2xl font-bold text-warning-600">{aiContent?.professional_assessment?.expert_rating?.value_for_money || 0}/10</div>
                    <div className="text-sm text-primary-600">Value for Money</div>
                  </div>
                  <div className="text-center p-4 bg-primary-50 rounded-lg">
                    <div className="text-2xl font-bold text-primary-600">{aiContent?.professional_assessment?.expert_rating?.versatility || 0}/10</div>
              ...
              <div>
                ...
                <p className="text-primary-700 leading-relaxed">{aiContent?.professional_assessment?.competitive_position || 'No competitive analysis available.'}</p>
              </div>
            </>
          )}
        </div>
